              ...
              <div className="card-professional p-8 rounded-3xl shadow-professional">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="heading-secondary text-2xl font-bold">
                      "{selectedItem.topic}"
                    </h3>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {selectedItem.quotes.map((quote, quoteIndex) => (
                    <div key={quoteIndex} className="flex items-start space-x-4 p-4 rounded-2xl bg-primary-navy/20">
                      ...
                      <blockquote className="text-lg italic text-high-contrast leading-relaxed text-left">
                        "{quote}"
                      </blockquote>
                    </div>
                  ))}
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-110 p-2 rounded-full bg-primary-navy/20 hover:bg-primary-navy/30"
